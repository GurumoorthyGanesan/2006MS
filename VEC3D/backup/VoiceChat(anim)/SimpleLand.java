...
/* <p>Title : SimpleLand </p>
 * @Author : Y.Y.Lin</P>
 * @Date : 07/04/04</p>
 * <p>Description : create the terrain.
 */
 ...
 public class SimpleLand extends javax.media.j3d.Shape3D{
 	...
 	/* Create a new instance of SimpleLand.
 	...
 	public SimpleLand(int length, int width,String texture){
        ...
        try{
        	...
        	TextureAttributes texatt = new TextureAttributes(TextureAttributes.BLEND,
        			new Transform3D(),new Color4f(1.0f, 1.0f, 1.0f, 1.0f), TextureAttributes.NICEST);
 	...
 	} // end of SimpleLand constructor
 } // end of SimpleLand method
