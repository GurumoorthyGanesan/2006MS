...
public class MoveMorph extends javax.media.j3d.Behavior {
    ...
    /*
     * Returns the size of the step for the current frame based on the time of the 
     * previous step. 
